...
public class CandlestickFactoryTest {
	...
	public void apenasUmaNegociacaoGeraCandleComValoresIguais() {
		...
		Assert.assertEquals(40.5, candle.getAbertura(), 0.00001);
		Assert.assertEquals(40.5, candle.getFechamento(), 0.0001);
	...
	public void paraNegociacoesDeTresDiasDistintosGeraTresCandles() {
		...
		List<Negociacao> negociacoes = Arrays.asList(negociacao1, negociacao2, negociacao3, negociacao3, negociacao5,
